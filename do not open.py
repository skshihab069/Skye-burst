...
# Game tittle & icon
pygame.display.set_caption("Skye burst")
...
for i in range(number_of_enemies):
    enemy_img.append(pygame.image.load('maruff.png'))
...
def game_over_text():
    game_over = over_font.render('MARUF KILLED U', True, (255, 51, 153))
    screen.blit(game_over, (200, 250))


def show_score(x,y):
    score = font.render('Maruff killed :' + str(score_value), True, (255, 0, 255))
